...
pub use schema::{
    AuthConfig, DeviceConfig, DeviceIdentity, IoConfig, LimitsConfig, PathsConfig, ProfileKind,
    ProgramConfig, ScanConfig, StopOutputPolicy, TaskConfig, TelemetryConfig, WatchdogConfig,
